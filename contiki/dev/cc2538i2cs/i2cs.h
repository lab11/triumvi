...
void i2c_slave_init(uint8_t slaveAddr);
void i2c_slave_disable(void);
void i2c_slave_int_enable(void);
void i2c_slave_int_disable(void);
void i2c_slave_int_enable_ex(uint32_t interruptFlags);
void i2c_slave_int_disable_ex(uint32_t interruptFlags);
void i2c_slave_int_clear(void);
void i2c_slave_int_clear_ex(uint32_t interruptFlags);
void i2c_slave_data_put(uint8_t data);
uint32_t i2c_slave_data_get(void);
